...
<form action="#" class="grid gap-8">
    <div class="relative">
        ...
        <input type="text" class="py-3 pl-16 rounded-md block w-full" placeholder="Nama Anda">
    </div>
    <div class="relative">
        ...
        <input type="text" class="py-3 pl-16 rounded-md block w-full" placeholder="Email / Nomer WA">
    </div>
    <div class="relative">
    ...
    <div class="relative">
        <svg class="absolute top-1/2 left-9 transform-gpu -translate-y-1/2 -translate-x-1/2" xmlns="http://www.w3.org/2000/svg" width="23.521" height="36.117" viewBox="0 0 23.521 36.117">
          ...
          <input type="text" class="py-3 pl-16 rounded-md block w-full" placeholder="Ulangi Password Anda">
    </div>
    <div>
        <p class="inline-block text-white pr-3">Password Strength</p>
        <span class="rounded-lg w-16 h-3 bg-lightBlue inline-block"></span>
        <span class="rounded-lg w-16 h-3 bg-lightBlue inline-block"></span>
        <span class="rounded-lg w-16 h-3 bg-white inline-block"></span>
    </div>
    <button type="submit" formaction="/filldata" class="bg-yellowLight text-darkGray font-bold rounded-lg py-3 px-16 justify-self-center items-center">Daftar</button>
</form>
@endsection